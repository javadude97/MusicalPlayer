...
public class Song {
     ...
     */
    public Song(String defaultTranslation, String miwokTranslation, int audioResourceId) {
     ...
     * @param audioResourceId is the resource ID for the audio file associated with this word
     */
    public Song(String defaultTranslation, String miwokTranslation, int imageResourceId,
                int audioResourceId) {
        mDefaultTranslation = defaultTranslation;
        mMiwokTranslation = miwokTranslation;
